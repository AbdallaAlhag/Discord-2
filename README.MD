...
- [ ] update and remove mock users, try to make it more intuitive for people -> root group chat and suggest add friends?
---
...
- [ ] show members list tool tip says show members list even when they are shown, change to hide
